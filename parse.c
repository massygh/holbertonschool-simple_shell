...
char **parseLine(char *line)
{
    ...
    int count_token = 0, i = 0; /* count the number of words and index */    /* Duplicate the line and store it in copy_line */
    ...
    count_token++; /* increment the number of words for the NULL sign */    /* Allocate memory for the tokens (array of token) */
